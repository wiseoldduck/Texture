...
/**
 * Whether we should avoid remeasuring cell nodes when the collection bounds is empty e.g. (375x0).
 *
 * This improves performance in cases where a collection view is hidden by setting its
 * height to 0. Defaults to NO. Default may change to YES in the future.
 */
